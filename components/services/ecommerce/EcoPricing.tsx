...
import { ECO_PRICING_PLANS, ECO_PRICING_SECTION } from "@/lib/ecommerce-data";
              ...
              >
                {recommended && (
                  <div className="shrink-0 bg-[#0EC47B] px-4 py-2.5 text-center font-montserrat text-[12px] font-bold uppercase tracking-[0.08em] text-white">
                    {ECO_PRICING_SECTION.recommendedLabel}
                  </div>
                )}
                ...
                <div className="flex min-h-0 flex-1 flex-col px-7 pb-7 pt-8">
                  ...
                  <div className="mt-auto pt-6">
                    <Link
                      href={ECO_PRICING_SECTION.ctaHref}
                    ...
                    >
                      <span>{ECO_PRICING_SECTION.cta}</span>
