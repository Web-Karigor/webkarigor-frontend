...
import { WEBSITE_DESIGN_DEVELOPMENT_FEATURES, WEBSITE_DESIGN_DEVELOPMENT_FEATURES_SECTION } from "@/lib/website-design-development-data";
    ...
    <section className="erp-features bg-white py-[clamp(48px,6vw,80px)]">
      <div className="mx-auto flex w-full max-w-[1680px] flex-col gap-8 px-[clamp(16px,4vw,120px)] md:gap-10 lg:gap-12">
        <div className="erp-features-head flex w-full flex-col gap-5 md:gap-6 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
          <div className="erp-features-copy max-w-[640px] shrink-0">
            <p className="m-0 font-montserrat text-[16px] font-semibold leading-none text-[#15d286] sm:text-[18px]">
              {WEBSITE_DESIGN_DEVELOPMENT_FEATURES_SECTION.eyebrow}
            </p>
            <h2 className="mt-3 m-0 font-montserrat text-[clamp(28px,3.2vw,40px)] font-bold leading-[1.15] tracking-[-0.02em] text-black">
              {WEBSITE_DESIGN_DEVELOPMENT_FEATURES_SECTION.title}
            </h2>
          </div>
          <p className="erp-features-lead m-0 w-full max-w-[650px] font-manrope text-[clamp(15px,1.5vw,18px)] font-semibold leading-[150%] text-[#A7A7A7] lg:shrink-0">
            {WEBSITE_DESIGN_DEVELOPMENT_FEATURES_SECTION.description}
          </p>
        </div>
        ...
        <div className="erp-features-grid mx-auto grid w-full max-w-[1188px] grid-cols-1 items-stretch gap-6 md:grid-cols-2 md:gap-8 lg:gap-[52px]">
          {WEBSITE_DESIGN_DEVELOPMENT_FEATURES.map((feature) => {
