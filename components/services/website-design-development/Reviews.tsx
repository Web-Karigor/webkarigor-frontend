...
import { WEBSITE_DESIGN_DEVELOPMENT_REVIEWS_SECTION, WEBSITE_DESIGN_DEVELOPMENT_TESTIMONIALS } from "@/lib/website-design-development-data";
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="m-0 font-montserrat text-[clamp(24px,2.8vw,32px)] font-bold leading-none tracking-[-0.02em] text-[#18214D]">
              {WEBSITE_DESIGN_DEVELOPMENT_REVIEWS_SECTION.title}
            </h2>
          </div>
