...
import websiteContent from "@/data/website-design-development-content.json";
          ...
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`home-pricing-avail is-pill is-${plan.availabilityTone}${plan.availabilityMarquee ? " is-marquee" : ""
                      }`}
                  >
                    <span
                      className={`home-pricing-dot${plan.availabilityTone === "red" ? " is-red" : ""
                        }`}
                      aria-hidden
                    >
