...
import { ERP_PRICING_PLANS, ERP_PRICING_SECTION } from "@/lib/erp-data";
              ...
              >
                {recommended && (
                  <div className="shrink-0 bg-[#0EC47B] px-4 py-2.5 text-center font-montserrat text-[12px] font-bold uppercase tracking-[0.08em] text-white">
                    {ERP_PRICING_SECTION.recommendedLabel}
                  </div>
                )}
                ...
                <div className="flex min-h-0 flex-1 flex-col px-7 pb-7 pt-8">
                  ...
                  <ul className="m-0 flex list-none flex-col gap-3.5 p-0">
                    {plan.features.map((feature) => (
                      ...
                      >
                        <span className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#2563EB]/10 text-[#2563EB]">
                  ...
                  <div className="mt-auto pt-6">
                    <Link
                      href={ERP_PRICING_SECTION.ctaHref}
                    ...
                    >
                      <span>{ERP_PRICING_SECTION.cta}</span>
